...
- **Primary output**: `docs/04_Task/tasks.md` — structured task list containing title, description, inputs, outputs, acceptance_criteria, and dependencies
...
- [ ] `docs/04_Task/tasks.md` is generated and formatted as a structured task list.
...
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | --------------- |
| Template structure    | `docs/04_Task/tasks.md` contains title, description, inputs, outputs, acceptance_criteria, dependencies                              | review-enforced |
